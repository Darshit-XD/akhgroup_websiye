        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="inline-block">
              <span className="bg-red-900/10 text-red-700 px-4 py-2 rounded-full text-sm font-medium border border-red-900/20">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="group bg-red-800 text-white px-8 py-4 rounded-full font-semibold hover:bg-red-700 transition-all duration-300 hover:scale-105 shadow-lg shadow-red-800/50 flex items-center justify-center gap-2"
              >
                Explore Projects
              ...
              <button
                ...
                className="bg-transparent border-2 border-red-800 text-red-700 px-8 py-4 rounded-full font-semibold hover:bg-red-800 hover:text-white transition-all duration-300"
              >
                Get in Touch
              </button>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              <div className="text-center">
                ...
                <div className="text-gray-400 text-sm">Landmark Projects</div>
              </div>
          ...
          <div className="relative hidden lg:block">
            <div className="relative">
              <div className="absolute inset-0 bg-red-900/20 rounded-3xl blur-3xl"></div>
              <img
                src="https://images.pexels.com/photos/323780/pexels-photo-323780.jpeg?auto=compress&cs=tinysrgb&w=1200"
                alt="Luxury Property"
                className="relative rounded-3xl shadow-2xl shadow-red-800/20 w-full h-[600px] object-cover border border-red-900/20 sepia-[0.3] brightness-[0.8]"
              />
            </div>
          </div>
        </div>
